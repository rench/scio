...
@EnableZuulProxy
@ComponentScan(basePackages = "com.scio.cloud.oauth2")
public class ScioOauth2Application {

  public static void main(String[] args) {
    SpringApplication.run(ScioOauth2Application.class, args);
  }
}
